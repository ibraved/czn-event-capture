...
> **Pinned to commit `646c07b`.** The install command below points at this exact commit, not a branch. The `bootstrap.ps1` script itself pins SHA256 hashes of every downstream file. Verify by clicking the commit link above and reading the script before running it.
...
```powershell
irm 'https://raw.githubusercontent.com/ibraved/czn-event-capture/646c07bab2250f9ec17ffa2228f50fe091119bf5/bootstrap.ps1' | iex
```
