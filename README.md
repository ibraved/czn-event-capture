...
> **Pinned to commit `b433f86`.** The install command below points at this exact commit, not a branch. The `bootstrap.ps1` script itself pins SHA256 hashes of every downstream file. Verify by clicking the commit link above and reading the script before running it.
...
```powershell
irm 'https://raw.githubusercontent.com/ibraved/czn-event-capture/b433f86afa101a866e4ca96af0c55b9781f2b07c/bootstrap.ps1' | iex
```
