...
> **Pinned to commit `0611b32`.** The install command below points at this exact commit, not a branch. The `bootstrap.ps1` script itself pins SHA256 hashes of every downstream file. Verify by clicking the commit link above and reading the script before running it.
...
```powershell
irm 'https://raw.githubusercontent.com/ibraved/czn-event-capture/0611b327ac072ea6a63eb4ccc0c2f22d8b758851/bootstrap.ps1' | iex
```
